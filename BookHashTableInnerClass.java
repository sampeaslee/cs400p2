...
public class BookHashTableInnerClass implements HashTableADT<String, Book> {
     ...
     */
    public BookHashTableInnerClass() {
     ...
     */
    public BookHashTableInnerClass(int initialCapacity, double loadFactorThreshold) {
        this.capacity = initialCapacity;
        hashTable = new ArrayList<LinkedList<KeyValue>>(initialCapacity);
    ...
    private ArrayList<KeyValue> getAllKeyValues() {
        ...
        for (int i = 0; i < hashTable.size(); i++) {
            LinkedList<KeyValue> bucket = hashTable.get(i);
            if (bucket == null) {
                continue;
            } else {
    ...
    private void reHash(ArrayList<KeyValue> keyValues)
        ...
        this.hashTable = new ArrayList<LinkedList<KeyValue>>(capacity);
        this.numKeys = 0;
    ...
    public static void main(String[] args) {
        try {
            ...
            BookHashTableInnerClass hashTable = new BookHashTableInnerClass(5, .7);
            ...
            ArrayList<KeyValue> test = hashTable.getAllKeyValues();
            for (int i = 0; i < test.size(); i++) {
                System.out.println(test.get(i).getValue());
            }
